...
@Component({
  ...
  styles: [`
    ...
    .search-wrapper { position: relative; display: flex; align-items: center; background: white; border: 1.5px solid #e2e8f0; border-radius: 12px; overflow: hidden; transition: border-color 0.18s, box-shadow 0.18s; }
    ...
    .search-wrapper input { width: 100%; padding: 12px 14px 12px 42px; border: none; outline: none; font-size: 0.9rem; background: transparent; color: #1e293b; }
    ...
    .avatar { width: 36px; height: 36px; background: #edf5ee; color: #2d6a4f; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 0.78rem; flex-shrink: 0; }
